...
map = read_tsv("./data/HILpos_batch_file.txt") 
```

```{r}
# Call in raw feature table ----
ft = read_tsv("./data/ComBat_mzcalibrated_targeted_featuretable_mz10ppm_time10.txt")
```
...
ft_70_normalize |> write_tsv("data/hilic_70detect_log2.txt") # change for HILIC    
mztime_70 |> write_tsv("data/hilic_70detect_mz_time.txt") # change for HILIC
```
